...
### EntriesHierarchy file and entries hierarchy tests
- Files changed: `Wordfolio.Api/Wordfolio.Api.DataAccess/EntriesHierarchy.fs`, `Wordfolio.Api/Wordfolio.Api/Infrastructure/Environment.fs`, `Wordfolio.Api/Wordfolio.Api.DataAccess.Tests/EntriesHierarchy/GetEntryByIdWithHierarchyTests.fs`, `Wordfolio.Api/Wordfolio.Api.DataAccess.Tests/EntriesHierarchy/ClearEntryChildrenTests.fs`, `Wordfolio.Api/Wordfolio.Api.DataAccess.Tests/EntriesHierarchy/GetEntriesHierarchyByVocabularyIdTests.fs`, `Wordfolio.Api/Wordfolio.Api.DataAccess.Tests/EntriesHierarchyTests.fs`, `Wordfolio.Api/Wordfolio.Api.DataAccess.Tests/Wordfolio.Api.DataAccess.Tests.fsproj`, `docs/data-access-refactoring/spec.md`
