...
type CreateCollectionsTable() =
    ...
    override this.Up() =
        base.Create
            ...
            .AsString()
            .Nullable()
            .WithColumn(CollectionsTable.CreatedAtDateTimeColumn)
            .AsDateTimeOffset()
            .NotNullable()
            .WithColumn(CollectionsTable.CreatedAtOffsetColumn)
            .AsInt16()
            .NotNullable()
            .WithColumn(CollectionsTable.UpdatedAtDateTimeColumn)
            .AsDateTimeOffset()
            .NotNullable()
            .WithColumn(CollectionsTable.UpdatedAtOffsetColumn)
            .AsInt16()
            .NotNullable()
        |> ignore
