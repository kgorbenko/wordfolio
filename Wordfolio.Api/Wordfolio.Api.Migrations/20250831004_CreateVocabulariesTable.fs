...
type CreateVocabulariesTable() =
    ...
    override this.Up() =
        base.Create
            ...
            .AsString()
            .Nullable()
            .WithColumn(VocabulariesTable.CreatedAtDateTimeColumn)
            .AsDateTimeOffset()
            .NotNullable()
            .WithColumn(VocabulariesTable.CreatedAtOffsetColumn)
            .AsInt16()
            .NotNullable()
            .WithColumn(VocabulariesTable.UpdatedAtDateTimeColumn)
            .AsDateTimeOffset()
            .NotNullable()
            .WithColumn(VocabulariesTable.UpdatedAtOffsetColumn)
            .AsInt16()
            .NotNullable()
        |> ignore
